      ...
      <div className={styles.gallery}>
        <div className={styles.gallery_video_block}>
          ...
          {/* <svg width="923" height="625" viewBox="0 0 923 625" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="550.375" y="75.1789" width="309" height="551" transform="rotate(-6.666 550.375 75.1789)" fill="white" stroke="#FF0000" stroke-width="2" />
          ...
          {/* <svg width="921" height="637" viewBox="0 0 921 637" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="612.261" y="35.4065" width="309" height="551" transform="rotate(6.62047 612.261 35.4065)" fill="white" stroke="#FF0000" stroke-width="2" />
          ...
          {/* <svg width="961" height="631" viewBox="0 0 961 631" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="658.178" y="22.8951" width="309" height="551" transform="rotate(12.9577 658.178 22.8951)" fill="white" stroke="#FF0000" stroke-width="2" />
          ...
          {/* <svg width="944" height="619" viewBox="0 0 944 619" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="570.671" y="53.9358" width="309" height="551" transform="rotate(-4.64356 570.671 53.9358)" fill="white" stroke="#FF0000" stroke-width="2" />
          ...
          {/* <svg width="938" height="640" viewBox="0 0 938 640" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="561.25" y="79.7077" width="309" height="551" transform="rotate(-5.39492 561.25 79.7077)" fill="white" stroke="#FF0000" stroke-width="2" />
        ...
        <div className={styles.gallery_descr_block}>
          {/* <div className={styles.text}>
          <h2 className={styles.text_title}>ЯКУТИЯ</h2>
          <p className={styles.text_descr}>Мороз,солнце, свет, лёд<br />и музыка на варгане. Маски<br />про ощущение и дух Якутии<br />от Полины Залевской</p>
        </div>
        <div className={styles.text}>
          <h2 className={styles.text_title}>ТАТАРСТАН</h2>
          <p className={styles.text_descr}>Маски про водяную Су-Анасы<br />— это рассказ известной<br />татарской легенды в AR<br />формате от Адель Галимовой</p>
        </div>
        <div className={styles.text}>
          <h2 className={styles.text_title}>ЧУВАШИЯ</h2>
          <p className={styles.text_descr}>Серия фильтров от Кати<br />Курмышкиной, созданных на<br />основе Чувашской культуры:<br />образ элемента народного<br />костюма женской шапки тухьи,<br />дерево жизни с герба Чувашии<br />и бабочки-орнаменты</p>
        </div>
        <div className={styles.text}>
          <h2 className={styles.text_title}>УРАЛ</h2>
          <p className={styles.text_descr}>Маски от Кати Алещенко<br />о мире уральского писателя<br />Павла Бажова, где реальность<br />и фантастика порой<br />неразличимы.</p>
        </div>
        <div className={styles.text}>
          <h2 className={styles.text_title}>КОМИ</h2>
          <p className={styles.text_descr}>Инстаграм фильтры,<br />основанные на работах<br />сыктывкарского художника<br />Юрия Лисовского. Используя<br />элементы традиционной<br />культуры республики Коми,<br />он создал свой уникальный<br />визуальный стиль —<br />Этнофутуризм.<br />Маски от Яски Добровой</p>
        </div>
        <div className={styles.text}>
